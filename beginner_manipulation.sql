...
select*from orders
where Customer_ID = 1 and Order_Time between '2017-02-01' and '2017-03-01'
...
select*from orders
where Order_Time between '2017-02-01' and '2017-03-01' 
...
select * from products 
where Coffee_Origin = 'Sri Lanka' or Price > 3;

delete from products;

insert into products (ID, Name, Price, Coffee_Origin)
values (1, 'Espresso', 2.50, 'Colombia'), (2, 'Macchiato', 3.00, 'Colombia'), (3, 'Cappuccino', 3.50, 'Costa Rica'), (4, 'Lathe', 3.50, 'Indonesia'), (5, 'Americano', 3.25, 'Ethiopia'), (6, 'Flat White', 3.25, 'Indonesia'), (7, 'Filter', 3.00, 'Sri Lanka');

select First_Name, Gender from customers;

drop table products;

create table orders (ID int auto_increment primary key, Product_ID int, Customer_ID int, Order_Time datetime); 
alter table orders
drop foreign key foreign_orders_products;
